/**
 * @fileoverview Заглушка раздела «Дневник настроения» MamaBot.
 *
...
/**
 * Показывает заглушку раздела «Дневник настроения» и возвращает в главное меню.
 *
 * @param {number|string} chatId - Telegram chat ID
 * @returns {Promise<Object>} Результат
 */
async function showMoodPlaceholder(chatId) {
  const msg = await _t(chatId, 'mood.coming_soon');
  ...
  return { status: 'mood_placeholder' };
}
...
module.exports = { showMoodPlaceholder, __inject };
