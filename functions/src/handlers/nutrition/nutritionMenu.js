/**
 * @fileoverview Заглушка раздела «Питание» MamaBot.
 *
...
/**
 * Показывает заглушку раздела «Питание» и возвращает в главное меню.
 *
 * @param {number|string} chatId - Telegram chat ID
 * @returns {Promise<Object>} Результат
 */
async function showNutritionPlaceholder(chatId) {
  const msg = await _t(chatId, 'nutrition.coming_soon');
  ...
  return { status: 'nutrition_placeholder' };
}
...
module.exports = { showNutritionPlaceholder, __inject };
